...
// ✅ FIBER INVENTORY QUERY
  try {
    ...
    res.json({
      totalSites: siteCountResult[0]?.totalSites || 0,
      totalManpower: manpowerActiveResult[0]?.totalManpower || 0,
      totalScrum: manpowerTotalResult[0]?.totalScrum || 0,
      fiberBreakdown: fiberSummary?.cards || [],
